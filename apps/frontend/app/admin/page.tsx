          ...
          <>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <Link href="/admin/ai" className="card p-5 hover:-translate-y-0.5 hover:shadow-md transition-all duration-200">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-xl bg-sky-50 dark:bg-sky-400/10 border border-sky-200 dark:border-sky-400/20 flex items-center justify-center text-sky-500 dark:text-sky-400">
                      <svg width="18" height="18" viewBox="0 0 14 14" fill="none">
                        <path d="M7 1.5L8 5.5l4 1-4 1-1 4-1-4-4-1 4-1 1-4z" stroke="currentColor" strokeWidth="1.2" strokeLinejoin="round"/>
                      </svg>
                    </div>
                    <div>
                      <p className="font-mono text-[12px] font-semibold text-slate-800 dark:text-slate-200">{t.dashboard?.generatorTitle ?? 'Generador de Texto'}</p>
                      <p className="font-mono text-[9px] text-slate-400 mt-0.5">Crea contenido con IA</p>
                    </div>
                  </div>
                </Link>
                ...
                <Link href="/admin/ai" className="card p-5 hover:-translate-y-0.5 hover:shadow-md transition-all duration-200">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-xl bg-emerald-50 dark:bg-emerald-400/10 border border-emerald-200 dark:border-emerald-400/20 flex items-center justify-center text-emerald-500 dark:text-emerald-400">
                      <svg width="18" height="18" viewBox="0 0 14 14" fill="none">
                        <path d="M2 10l3-3 2 2 5-6 2 2-7 5" stroke="currentColor" strokeWidth="1.2" strokeLinejoin="round"/>
                      </svg>
                    </div>
                    <div>
                      <p className="font-mono text-[12px] font-semibold text-slate-800 dark:text-slate-200">{t.dashboard?.summarizerTitle ?? 'Resumidor'}</p>
                      <p className="font-mono text-[9px] text-slate-400 mt-0.5">Resume documentos</p>
                    </div>
                  </div>
                </Link>
              </div>
