...
export const Spinner = ({ sm }: { sm?: boolean }) => (
  <span
    className={`${
...
export const AtsRing = ({ score, large }: { score: number; large?: boolean }) => {
  ...
  return (
    ...
    >
      ...
      <span
        className={`absolute font-mono font-bold ${large ? 'text-[12px]' : 'text-[10px]'}`}
        style={{ color }}
      >
        {score}%
      </span>
