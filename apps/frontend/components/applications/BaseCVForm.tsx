...
function fieldStatusOf(rubricKey: string, fb: Record<string, string>, hasEval: boolean): FieldStatus {
  ...
  if (hint === undefined || hint === '·') return 'pending';
  if (hint === '') return 'ok';
  ...
  return (
    <div className="space-y-2 pt-2">
      <div className="flex items-center gap-3">
        ...
        {score >= MIN_SCORE && (
          <span
            className="font-mono text-[9px] px-2 py-0.5 rounded-full flex items-center gap-1 whitespace-nowrap
...
export function BaseCVForm({ initialCV, onSaved, t, lang }: Props) {
  ...
  function updateField(key: keyof BaseCV, value: string) {
    ...
    if (fb[rk] === '') {
      setEvalResult((prev) =>
        prev ? { ...prev, fieldFeedback: { ...prev.fieldFeedback, [rk]: '·' } } : prev
      );
    }
  }
  ...
  const textareaFields = [
    {
      key: 'summary' as keyof BaseCV,
      rows: 5,
      label: ta.fieldSummary,
      hint: ta.hintSummary,
      ph: ta.fieldSummaryPlaceholder,
    },
    {
      key: 'experience' as keyof BaseCV,
      rows: 10,
      label: ta.fieldExperience,
      hint: ta.hintExperience,
      ph: ta.fieldExperiencePlaceholder,
    },
    {
      key: 'education' as keyof BaseCV,
      rows: 3,
      label: ta.fieldEducation,
      hint: ta.hintEducation,
      ph: ta.fieldEducationPlaceholder,
    },
    {
      key: 'skills' as keyof BaseCV,
      rows: 3,
      label: ta.fieldSkills,
      hint: ta.hintSkills,
      ph: ta.fieldSkillsPlaceholder,
    },
    {
      key: 'languages' as keyof BaseCV,
      rows: 2,
      label: ta.fieldLanguages,
      hint: ta.hintLanguages,
      ph: ta.fieldLanguagesPlaceholder,
    },
    {
      key: 'certifications' as keyof BaseCV,
      rows: 2,
      label: ta.fieldCertifications,
      hint: ta.hintCertifications,
      ph: ta.fieldCertificationsPlaceholder,
    },
  ];
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="card p-6 space-y-8">
              ...
              return (
                <div key={f.key}>
                  ...
                  <input
                    ...
                    disabled={lk}
                    className={`input-field transition-all ${STATUS_RING[st]} ${
                      lk ? 'opacity-60 cursor-not-allowed bg-slate-50 dark:bg-slate-900/40' : ''
                    }`}
                  />
        ...
        <div
          className="border border-slate-200 dark:border-slate-700 rounded-xl p-5 space-y-4
        ...
        >
          ...
          {score !== null && score > 0 && <ScoreBar score={score} summary={evalResult?.summary ?? ''} t={ta} />}
